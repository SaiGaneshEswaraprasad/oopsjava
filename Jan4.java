...
class Jan4 {
    ...
    protected void finalize() throws Throwable {
        try {
            System.out.println("Finalizing the Jan4 object.");
        } finally {
            super.finalize();
        }
    }
